...
def dolaunch(sock = None, _account ="yu6786878", _password ="121234561233", _device="1236578557321"):
    sock.send(encrypt_LaunchRequest_Pack(protobuf = (1, 2, 1), account = _account, password = _password, device= _device ))
    data = sock.recv(1024)
    if data:
